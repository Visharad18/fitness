 ...
 *
 * @copyright     Copyright (c) Cake Software Foundation, Inc. (https://caefoundation.org)
...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/register',['controller' => 'Logins', 'action' => 'register']);
    $routes->connect('/login',['controller' => 'Logins', 'action' => 'login']);
...
Router::scope('/sessions', function (RouteBuilder $routes) {
    $routes->connect('/add',['controller' => 'Sessions', 'action' => 'add']);
});

Router::scope('/full-calendar', function (RouteBuilder $routes) {
    $routes->connect('/',['plugin' => 'FullCalendar','controller' => 'FullCalendar']);
    $routes->fallbacks(DashedRoute::class);
});
